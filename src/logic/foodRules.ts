...
const DANGER_FOOD_RULES: FoodRule[] = [
  ...
  },
  {
    ...
    riskLevel: "danger",
    actions: [
      "포도나 건포도 섭취는 개체별 반응 차이가 커서 섭취량이 적어 보여도 빠른 동물병원 상담 권장 상황입니다.",
  ...
  },
  {
    ...
    actions: [
      ...
      "먹은 양과 시간을 기록하고, 배가 부풀거나 힘들어 보이는지 확인해 주세요.",
...
const CAUTION_FOOD_RULES: FoodRule[] = [
  ...
  {
    keywords: ["닭뼈", "생선뼈", "갈비뼈", "익힌 뼈", "뼈 간식", "chicken bone", "fish bone", "cooked bone"],
    riskLevel: "caution",
    actions: [
  ...
  },
  {
    ...
    riskLevel: "caution",
    actions: [
      "생고기는 위장 불편이나 세균 노출 가능성이 있어 추가 급여를 피해주세요.",
      "설사, 구토, 식욕 저하, 처짐이 나타나는지 관찰해 주세요.",
      "어린 강아지, 노령견, 기저질환이 있는 경우 상담을 더 이르게 고려해 주세요.",
    ],
  },
  {
    keywords: ["기름진", "튀김", "삼겹살", "치킨", "피자", "버터", "크림", "fatty", "fried"],
    riskLevel: "caution",
    actions: [
